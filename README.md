...
A modern, high-performance Movie Application built with the latest **React 19** features. This app allows users to discover trending movies, search for their favorites, and experience a seamless UI/UX powered by **Tailwind CSS** and **Appwrite** for the backend logic and database.
...
- 🔍 **Search Movies:** Easily find any movie using the integrated search functionality.
- 📈 **Trending Algorithm:** A dynamic ranking system that displays movies based on real-time popularity.
